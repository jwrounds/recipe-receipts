...
const SignupForm = ( { user, onUserFormChange, onSignup }: LoginFormProps ): JSX.Element => {
            ...
            <div className="card shadow-2-strong" style={{borderRadius: '1rem'}}>
              <div className="card-body p-5 ">
                ...
                <div className="form-outline mb-4">
                  ...
                  <input type="email" id="email" className="form-control form-control-lg" value={user.email} onChange={onFormChange}/> 
                </div>
                ...
                <button className="btn btn-primary btn-lg btn-block" type="submit" onClick={onSignup}>Login</button>
