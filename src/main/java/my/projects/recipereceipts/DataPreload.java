...
public class DataPreload {
    ...
    CommandLineRunner initDatabase(RecipeRepository recipeRepository) {
        return args -> {
            ...
            Recipe streetTacos = new Recipe("Shredded Chicken Street Tacos", "Street tacos loaded with perfectly seasoned shredded chicken, diced onions, and topped with cilantro and lime juice.",
                    30, 55);
